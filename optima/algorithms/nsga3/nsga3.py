...
from optima.utils.lib import *
from optima.algorithms.algorithm import Algorithm
import optima.utils.tools as tools
import numpy as np
import pdb
from copy import deepcopy
from reference import DIVISIONS, cover
from optima.configs import nsga3_settings as default_settings
from optima.measures.igd import igd
...
if __name__ == "__main__":
  # from optima.problems.dtlz.dtlz1 import DTLZ1
  # o = DTLZ1(3)
  # nsga3 = NSGA3(o, pop_size=92, gens = 10)
  # nsga3.run()
  # exit(0)
  from FeatureModel.ftmodel import *
  m = FTModel('webportal', setConVioAsObj=True)
  o = OptimaFTModel(m)
  nsga3 = NSGA3(o, pop_size=100, gens=10)
  ppp = nsga3.run()
  pdb.set_trace()
