...
public class SinglePointCrossover extends Crossover {
     ...
     */
    private static final List VALID_TYPES = Arrays.asList(SPL_BinarySolution.class, BinarySolutionType.class,
        ...
        try {
            if (PseudoRandom.randDouble() < probability) {
                if ((parent1.getType().getClass() == BinarySolutionType.class) ||
                        (parent1.getType().getClass() == BinaryRealSolutionType.class) || parent1.getType().getClass() == SPL_BinarySolution.class) {
